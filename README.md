...
4. Render will parse `backend/render.yaml` and configure the service automatically.
5. In the Render Dashboard, go to your service's **Environment** tab and add the environment variables listed in the backend section.
6. Verify that the deployment build commands are:
